...
<form action="form.php" method="post" enctype="multipart/form-data">
	<input type="text" name="title" placeholder="write a some word for title"><label>Title</label></p>
	<textarea type="text" name="noidung" placeholder="write a something"></textarea><label>Nội Dung</label></p>
